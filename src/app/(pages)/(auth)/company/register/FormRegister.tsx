      ...
      <form id="registerForm" action="" className="grid grid-cols-1 gap-y-[15px]">
        ...
        <div className="">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 border border-[#DEDEDE] rounded-[4px] w-full h-[48px] font-[600] text-[16px] text-black hover:bg-gray-100 transition"
          >
            <img
